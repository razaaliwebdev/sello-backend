...
router.post("/:chatId/messages", auth, upload.array("attachments", 5), sendSupportMessage);
...
router.post("/:chatId/admin-response", upload.array("attachments", 5), sendAdminResponse);
